 ...
 * 设置响应消息 (0x7002)
 */
public class SetUpResponseMsg extends CncpBaseMsg {
	...
	public SetUpResponseMsg() {
		super();
	}
	
	public SetUpResponseMsg(char srcType,char destType,int messageLength,int messageType,int transId,int neType,int instId,char subType,char holdBit,char result,char resultHoldBit) {
