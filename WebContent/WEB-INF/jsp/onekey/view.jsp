...
<body>
	<div style="text-align:center;height:50px;">
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',size:'large'" onclick="oneexport()"><spring:message code="Export"></spring:message></a>
	</div><br/>
	<div style="text-align:center;height:100px;">
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',size:'large'" onclick="$('#w').window('open');"><spring:message code="Import"></spring:message></a>
	</div>
	...
	<div id="w" class="easyui-window" title="<spring:message code="UploadPackage"></spring:message>" data-options="modal:true,closed:true,iconCls:'icon-save'" style="text-align:center;width:600px;padding:10px;top:100px">
		<form id="ff" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/onekey/import.action">
			<label><spring:message code="SelectPackage(ZIPFormat)"></spring:message></label><br/><br/>
			...
			<br/><br/>
			<a href="#" class="easyui-linkbutton" onclick="oneimport()"><spring:message code="OneKeyImport"></spring:message></a>
		</form>
	</div>
</body>
</html>