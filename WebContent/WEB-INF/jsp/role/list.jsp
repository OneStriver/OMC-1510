...
<body>
	...
	<thead>
		<tr>
			...
			<th data-options="field:'name',width:'10%'"><spring:message code="RoleName"></spring:message></th>
			<th data-options="field:'description',width:'50%'"><spring:message code="Description"></spring:message></th>
	...
	<div id="tb" style="height:auto">
		...
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" 
			onclick="removeit('${pageContext.request.contextPath}/role/delete.action')"><spring:message code="Delete"></spring:message></a>
	</div>
</body>
</html>