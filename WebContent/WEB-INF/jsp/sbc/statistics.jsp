...
<div class="easyui-panel" title=" " data-options="fit:true">
	...
	<form id="ff" method="post" action="${pageContext.request.contextPath}/sbc/update${packid}Scalar.action">
    		...
    		<c:if test="${!config.sole}">
				...
				<c:when test="${formtype=='datagrid'}">
					...
					<table id="grid_${item.id}" class="easyui-datagrid" data-options="
						...
						fitColumns:true,toolbar:'#tb',rownumbers:true,loadFilter:loadFilter,
